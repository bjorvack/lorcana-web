...
export const CARDS_RELEASE_TAG = "cards-v2026.05.15-01";
 ...
 */
export const LEGALITY_RELEASE_TAG: string | null = "cards-v2026.08.01-01";
...
export const MODEL_RELEASE_TAG: string | null = "model-v0.10.0";
